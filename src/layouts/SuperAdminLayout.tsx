...
import { LayoutDashboard, LogOut, Users, Sun, Moon, Menu, X } from 'lucide-react';
          ...
          <div className="md:hidden fixed inset-0 z-50 flex">
            ...
            <div className="relative flex-1 flex flex-col max-w-xs w-full bg-bg-surface border-r border-border-main text-text-primary h-full shadow-2xl animate-in slide-in-from-left duration-300">
              <div className="p-4 border-b border-border-main flex items-center justify-between">
                 <Link to="/superadmin" className="flex items-center space-x-2" onClick={() => setIsMobileMenuOpen(false)}>
                   <div className="w-8 h-8 rounded bg-gradient-to-tr from-gold to-gold-light flex items-center justify-center text-black font-bold text-xs">
                     SUPER
                   </div>
                   <span className="font-bold text-lg">Plataforma</span>
                 </Link>
                 <button
                   onClick={() => setIsMobileMenuOpen(false)}
