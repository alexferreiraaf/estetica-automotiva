      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        ...
        <div className="bg-bg-surface border border-border-main rounded-xl p-6">
           <div className="flex items-center justify-between mb-4">
              <span className="text-text-secondary font-medium">Hoje</span>
              <div className="w-10 h-10 rounded-lg bg-neon-blue/10 flex items-center justify-center">
                 <Calendar className="w-5 h-5 text-neon-blue" />
              </div>
           </div>
           <p className="text-3xl font-bold text-text-primary">{stats.today}</p>
           <p className="text-sm text-text-muted mt-2">Agendamentos hoje</p>
        </div>

        <div className="bg-bg-surface border border-border-main rounded-xl p-6">
           <div className="flex items-center justify-between mb-4">
              <span className="text-text-secondary font-medium">Nesta Semana</span>
              <div className="w-10 h-10 rounded-lg bg-gold/10 flex items-center justify-center">
                 <CheckCircle2 className="w-5 h-5 text-gold" />
              </div>
           </div>
           <p className="text-3xl font-bold text-text-primary">{stats.week}</p>
           <p className="text-sm text-text-muted mt-2">Serviços na semana</p>
        </div>
        ...
        <div className="bg-bg-surface border border-border-main rounded-xl p-6">
           ...
           <p className="text-sm text-text-muted mt-2">Aguardando confirmação</p>
        </div>

        <div className="bg-bg-surface border border-border-main rounded-xl p-6">
           <div className="flex items-center justify-between mb-4">
              <span className="text-text-secondary font-medium">Volume Total</span>
              <div className="w-10 h-10 rounded-lg bg-green-500/10 flex items-center justify-center">
                 <DollarSign className="w-5 h-5 text-green-500" />
              </div>
           </div>
           <p className="text-3xl font-bold text-text-primary">R$ {stats.revenue.toFixed(2)}</p>
           <p className="text-sm text-text-muted mt-2">Projeção geral de receita</p>
        </div>
